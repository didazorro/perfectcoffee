...
class SignUpWidgetState extends State<SignUpWidget> {
        ...
        child: GetBuilder<AuthController>(builder: (authController) {
          return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            TramsConditionsCheckBoxWidget(
                authController: authController, fromSignUp: true, fromDialog: ResponsiveHelper.isDesktop(context) ? true : false),
  ...
  Future<SignUpBodyModel?> _prepareSignUpBody(String countryCode) async {
    ...
    String email = _emailController.text.trim().isEmpty ? "demo@gmail.com" : _emailController.text.trim();
